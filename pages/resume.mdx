...
-   Responsible for designing and developing a testing framework for an inter-platform communication driver. There were other frameworks in the company at that time, but none of them were suitable for the specific requirements of our project. So, we had to develop a new testing framework. This framework is mainly written in Python and has to adapt to some main requirements below:
